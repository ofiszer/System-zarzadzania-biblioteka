<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="OddajKsiazke.aspx.cs" Inherits="BibliotekaWebAppNoAuth.OddajKsiazke" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                          <asp:Button class="btn btn-lg btn-block btn-danger" ID="Button5" runat="server" Text="Oddaj" OnClick="Button5_Click"></asp:Button>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    ...
                                    <img src="Images/wracamy.png" height="300"/>
                        ...
                        <%--<div class="row">
                            <div class="col">
                                ...
                                <asp:GridView ID="GridView1" class="table table-striped table-bordered" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnRowDataBound="GridView1_RowDataBound" Visible="False">
                                    <Columns>
